...
interface WalletState {
  ...
  ensureCorrectArbitrumNetwork: () => Promise<void>;
...
export const useWalletStore =  create<WalletState> ((set, get) => ({
  ...
  ensureCorrectArbitrumNetwork: async () => {
    //@ts-ignore
  ...
  connectWallet: async () => {
    ...
    try {
      ...
      await get().ensureCorrectArbitrumNetwork();
  ...
  createStream: async (
    ...
    try {
      ...
      const code = await provider.getCode(Arbitrum_stream_address);
      if (!code || code === "0x") {
