      ...
      <section className="max-w-5xl mx-auto  mb-10 ">
        <div className="mt-12 bg-white/5 backdrop-blur-lg p-6 md:p-10 rounded-3xl border border-white/10">
          ...
          <p className="mt-3 max-w-3xl text-sm md:text-base text-white/70">
            Real-time money streaming on Arbitrum. Withdraw accrued funds or manage
        ...
        <p className="text-center text-3xl font-bold mt-8 text-[#7C3AED]">Streams</p>
          <div className="transform transition duration-500 hover:-translate-y-1 grid md:grid-cols-2  gap-8 mt-10">
            {
              isProcessing ? (
                <>
                  <Skeleton baseColor={'#7C3AED'}  height={150} className="rounded-3xl"/>
                  <Skeleton baseColor={'#7C3AED'}   height={150} className="rounded-3xl"/>
                </>
              ) : (
                <>
                            ...
                            return (
                              <div key={streamData.id} className="w-fit bg-white/5 backdrop-blur-lg p-6 md:p-10 rounded-3xl border border-white/10 text-white/70">
                                <div className="flex justify-between mb-4">
                                  <p className="text-xl font-bold text-[#7C3AED]">Incoming Streams</p>
                                  ...
                                  action="">
                                    ...
                                    <button
                                      ...
                                      className={`
                                        ...
                                        mt-8 w-full px-6 py-3 rounded-xl bg-[#7C3AED] text-black font-medium text-lg `}
                                    >
                                      Withdraw Funds
                                     </button>
                                  </motion.form>
                          ...
                          arrayOfSenderStreams.map((outgoingStream)=>{
                            return (
                              <div key={outgoingStream.id} className="bg-white/5 backdrop-blur-lg p-6 md:p-10 w-fit rounded-3xl border border-white/10 text-white/70">
                                  <div className="flex justify-between mb-4">
                                    <p className="text-xl  font-bold text-[#7C3AED]">Outgoing Streams</p>
                                  ...
                                  />
                                    ...
                                    disabled={!walletAddress || !outgoingStream[8]}
                                      className={`
                                        ...
                                        : 'bg-[#7C3AED] text-black hover:bg-purple-400'}
                                        mt-8 w-full px-6 py-3 rounded-xl bg-[#7C3AED] text-black font-medium cursor-pointer text-lg`}
                                    >
                                    Cancel Stream
                                    </button>
                                  </motion.form>
